...
public class SDFGraphicEditor : Editor
{
    ...
    public static void DrawSDFScene(SignedDistanceFieldGraphic graphic)
    {
        ...
        if (circleSettings)
        {
            ...
            var fmh_304_59_638396245599123953 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 3f, Vector3.one, Handles.SphereHandleCap);
        ...
        if (maskSettings)
        {
            ...
            var fmh_329_55_638396245599137114 = Quaternion.identity; maskPos = Handles.FreeMoveHandle(maskPos, 3f, Vector3.one, Handles.SphereHandleCap);
    ...
    public void OnSceneGUI()
    {
        ...
        if (m_showPoints)
        {
            ...
            for (int i = 0; i < graphic.Points.Length; ++i)
            {
                ...
                var fmh_522_63_638396245599142646 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 5f, Vector3.zero, Handles.SphereHandleCap);
    ...
    public void OnSceneGUI()
    {
        ...
        if (m_showPoints)
        {
            ...
            for (int i = 0; i < graphic.Points.Length; ++i)
            {
                ...
                var fmh_660_63_638396245599147084 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 5f, Vector3.zero, Handles.SphereHandleCap);
