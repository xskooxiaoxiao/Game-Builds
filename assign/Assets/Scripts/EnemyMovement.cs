...
void Awake()
    {
        ...
        */
        ...
        else if (sceneName == "Level2") 
		{
            ...
            pin[2] = new Vector3(2.0f,0.0f,15.0f);
            pin[3] = new Vector3(2.0f,0.0f,7.0f);
        ...
        else if (sceneName == "Level4") 
		{
            ...
            if (spawn == 1) // spawn and route 1
            {
                ...
                pin[0] = new Vector3(-18.0f,0.0f,20.0f);
                pin[1] = new Vector3(-18.0f,0.0f,15.0f);
                pin[2] = new Vector3(-9.0f,0.0f,15.0f);
                pin[3] = new Vector3(-9.0f,0.0f,4.0f);
                pin[4] = new Vector3(6.0f,0.0f,4.0f);
                pin[5] = new Vector3(6.0f,0.0f,0.0f);
            }
            else            // spawn and route 2
            {
                transform.position = new Vector3(-21.0f,enemyheight,3.0f);
                pin[0] = new Vector3(-21.0f,0.0f,3.0f);
                pin[1] = new Vector3(-12.0f,0.0f,3.0f);
                pin[2] = new Vector3(-12.0f,0.0f,7.0f);
                pin[3] = new Vector3(2.0f,0.0f,7.0f);
                pin[4] = new Vector3(2.0f,0.0f,15.0f);
                pin[5] = new Vector3(11.0f,0.0f,15.0f);
            }
